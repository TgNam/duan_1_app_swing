...
import com.editTable.HoverIndex;
import com.editTable.TableCustomCellRender;
import com.editTable.TableHeaderCustomCellRender;
import com.editTable.TextAreaCellRenderer;
...
import com.scroll.ScrollBarCustomUI;
...
public class TableCustom {
    ...
    public static void apply(JScrollPane scroll, TableType type) {
        ...
        //set header
        table.getTableHeader().setDefaultRenderer(new com.swing.TableHeaderCustomCellRender(table));
        ...
        table.getTableHeader().setBackground(new Color(24,152,199));
